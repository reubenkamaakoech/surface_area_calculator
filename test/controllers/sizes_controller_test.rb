...
class SizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create size" do
    assert_difference("Size.count") do
      post sizes_url, params: { size: { buying_price: @size.buying_price, name: @size.name, product_id: @size.product_id, selling_price: @size.selling_price, user_id: @size.user_id } }
    end
  ...
  test "should update size" do
    patch size_url(@size), params: { size: { buying_price: @size.buying_price, name: @size.name, product_id: @size.product_id, selling_price: @size.selling_price, user_id: @size.user_id } }
